...
로컬 개발                          프로덕션
─────────────────────────          ──────────────────────────────────
Next.js   localhost:3000           Vercel (app.yjcode.org) ← push to main
FastAPI   localhost:8001      →    Cloudflare Tunnel (api.yjcode.org)
MariaDB   localhost:3307 (Docker)      → Nginx → FastAPI (Docker, Hetzner)
                                           → MariaDB (Docker, Hetzner)
```
